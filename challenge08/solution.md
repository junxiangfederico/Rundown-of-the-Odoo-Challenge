# Odoo-Challenge solution for the challenge number 8
...
Here we find series of instructions, we export those in a file called "r.html", and use the script in /challenge08/script.py to retrieve the key 
